...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="#">View Produk</a>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $product['stock']; ?></td>
                    <td>
                        <a href="edit_product.php?id=<?= $product['id']; ?>" class="btn btn-success"><i class="fas fa-edit"></i> Edit</a>
                        <a href="delete_product.php?id=<?= $product['id']; ?>" class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus produk ini?');"><i class="fas fa-trash"></i> Hapus</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
